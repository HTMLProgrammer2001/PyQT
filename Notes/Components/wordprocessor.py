...
class NoteWindow(QMainWindow):
    ...
    def __init__(self, text = '', *args, **kwargs):
        super(NoteWindow, self).__init__(*args, **kwargs)

        self.setWindowModality(Qt.ApplicationModal)
        self.setWindowTitle('Notepad')
        self.setWindowIcon(QIcon('./images/Icon.ico'))

        self.saveEmitter = SaveSignal()
    ...
    def file_save(self):
        ...
        self.saveEmitter.emit(self.editor.toHtml())
    ...
    def closeEvent(self, e: QCloseEvent, *args, **kwargs):
        self.file_save()
